...
public class RedisClient extends io.lettuce.core.RedisClient {
    ...
    protected RedisClient(ClientResources clientResources, RedisURI redisURI, String dataChannel, char [] privateKey) {
    ...
    public static RedisClient create(ClientResources resources, RedisURI uri, String dataChannel, char [] privateKey) {
